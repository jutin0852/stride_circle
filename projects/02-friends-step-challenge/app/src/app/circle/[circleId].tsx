...
import { DailyRaceTrack } from '@/components/daily-race-track';
...
const styles = StyleSheet.create({
  ...
  historyHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 }, sectionTitle: { color: colors.ink, fontSize: 19, fontWeight: '800', marginTop: 8 }, historyLabel: { color: colors.muted, fontSize: 12, fontWeight: '700', marginTop: 8 }, dayPicker: { gap: 8, paddingRight: 4 }, day: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 14, borderWidth: 1, minWidth: 55, paddingHorizontal: 9, paddingVertical: 8 }, dayActive: { backgroundColor: colors.accent, borderColor: colors.accent }, dayText: { color: colors.muted, fontSize: 11, fontWeight: '800' }, dayDate: { color: colors.ink, fontSize: 14, fontVariant: ['tabular-nums'], fontWeight: '800', marginTop: 2 }, dayTextActive: { color: '#FFFFFF' }, dayPressed: { opacity: 0.75 }, todayHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 }, todayDate: { color: colors.accentPressed, fontSize: 10, fontWeight: '900', letterSpacing: 0.8 }, muted: { color: colors.muted, fontSize: 14, lineHeight: 20 }, loadingRows: { alignItems: 'center', flexDirection: 'row', gap: 10, minHeight: 68 },
